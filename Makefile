...
# Gonso
.PHONY: all copy cv copy_and_verify cs copy_and_synthesize e edit
all: copy_and_verify
cv: copy_and_verify
copy_and_verify: copy verify-honzales-rtl
...
edit:
	...
	vi verilog/dv/honzales/honzales.c verilog/rtl/user_proj_example.v
# Osnog
